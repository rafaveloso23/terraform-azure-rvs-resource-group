...
CATALOG_FILE="${CATALOG_FILE:-fake_catalog_response.json}"
MODULE_DIR="${MODULE_DIR:-.}"

# (Opcional) filtrar outputs para evitar ruído (regex de nome do output)
OUTPUT_PREFIX_FILTER="${OUTPUT_PREFIX_FILTER:-}"
